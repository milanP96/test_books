...
# CREATE_USER_URL = reverse('user:user-create_user')
...
class PublicUserApiTests(TestCase):
    ...
    def test_fail_to_create_user_by_unauthorized_user(self):
        """Test that unauthorized user can not create new user"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        """Test creating user by authenticated user with a valid payload is successful"""
        payload = {
            "email": "test@gmail.com", "password": "12345qwerty", "first_name": "Milan",
            "last_name": "Petkovic", "phone": "123234283"
        }
        # res = self.client.post(CREATE_USER_URL, payload)
